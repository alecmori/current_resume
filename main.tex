...
\heading{Jun 2018 - Present}{Yelp}{Machine Learning Engineer - Search UX}{San Francisco, CA}

\bulletpoint{Developing data infrastructure/machine learned models to improve search UI}

\bulletpoint{Designing experiments to balance many metrics alongside other teams}

\heading{Aug 2016 - Jun 2018}{Yelp}{Machine Learning Engineer - Ad Creative}{San Francisco, CA}
